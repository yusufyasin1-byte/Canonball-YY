...
async function main() {
  ...
  const outputDir = process.env.UIPATH_SOLUTION_OUTPUT_DIR
    ? path.resolve(process.env.UIPATH_SOLUTION_OUTPUT_DIR)
    : path.resolve(process.cwd(), "tmp", "native-solution-package");
